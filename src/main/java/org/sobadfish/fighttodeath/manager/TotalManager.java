...
import org.sobadfish.fighttodeath.manager.data.PlayerDataManager;
import org.sobadfish.fighttodeath.manager.data.PlayerTopManager;
import org.sobadfish.fighttodeath.panel.lib.AbstractFakeInventory;
import org.sobadfish.fighttodeath.room.config.GameRoomConfig;
import org.sobadfish.fighttodeath.room.event.defaults.CommandEvent;
import org.sobadfish.fighttodeath.room.event.defaults.CustomEvent;
import org.sobadfish.fighttodeath.room.event.defaults.EffectEvent;
...
public class TotalManager {
     ...
     * 游戏指令
     * */
    public static final String COMMAND_NAME = "fd";

    /**
     * 游戏管理员指令
     * */
    public static final String COMMAND_ADMIN_NAME = "fda";

    /**
     * 游戏内喊话指令
     * */
    public static final String COMMAND_MESSAGE_NAME = "fds";

    /**
     * 小游戏名称
     * */
    public static final String GAME_NAME = "FightToDeath";
